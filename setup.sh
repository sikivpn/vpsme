...
echo -e "$green.........................................................."$NC
echo -e "$Lyellow                  Autoscript By sikivpn"$NC
echo -e "$Lyellow                    CONTACT TELEGRAM"$NC
echo -e "$Lyellow                       @sikivpn"$NC
echo -e "$green.........................................................."$NC
echo ''
...
VALIDITY() {
    ...
    if [[ $today < $Exp1 ]]; then
        echo -e "\e[32mCongratulations! You are Allowed to use AUTOSCRIPT sikivpn..\e[0m"
        sleep 5
    else
...
echo -e "\e[1;32m══════════════════ Autoscript By sikivpn ══════════════════\e[0m" | tee -a log-install.txt
sleep 7
clear
echo ""
echo -e "    \e[1;32m.------------------------------------------.\e[0m"
echo -e "    \e[1;32m|     SUCCESFULLY INSTALLED THE SCRIPT     |\e[0m"
echo -e "    \e[1;32m|        PREMIUM BY sikivpn      |\e[0m"
echo -e "    \e[1;32m'------------------------------------------'\e[0m"
echo ""
